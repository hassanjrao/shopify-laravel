...
Line 69:24 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 70:8 Transforming const to the configured target environment ("es5") is not supported yet
Line 73:8 Transforming let to the configured target environment ("es5") is not supported yet
Line 74:8 Transforming let to the configured target environment ("es5") is not supported yet
Line 103:22 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 120:17 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 122:8 Transforming const to the configured target environment ("es5") is not supported yet
